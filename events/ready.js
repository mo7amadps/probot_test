...
// والله لو تحذفه لابندك ومارح اسامحك ليوم دين
              if (user) {
                const embed = new Discord.MessageEmbed()
                  ...
                  .setDescription(
                    `Hey ${user.username}, Premium in ${guildPremium.name} has Just expired :(\n\n__You can you re-new your server here! [http://astro.pylex.xyz:9310//premium](http://// صاحب بروجكت صلاح
// رابط قناته https://youtube.com/@nova-maker?si=_p7faJwEc0NGuoo2
// والله لو تحذفه لابندك ومارح اسامحك ليوم دين.pylex.xyz:9310//premium)__\n\nThank you for purchasing premium Previously! We hope you enjoyed what you purchased.\n\n**- Pogy**`
                  );
