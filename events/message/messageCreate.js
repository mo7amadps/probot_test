    ...
    try {
      ...
      if (message.content.match(mentionRegex)) {
        ...
        const embed = new MessageEmbed()
          ...
          .setDescription(
            `\nIf you like Pogy, Consider [voting](https://top.gg/bot/), or [inviting](${config.invite_link}) it to your server! Thank you for using Pogy, we hope you enjoy it, as we always look forward to improve the bot`
          )
          ...
          return message.channel
            .sendCustom(
              ` ${
                ...
                number === 2
                  ? "*You can check our top.gg page at `http://astro.pylex.xyz:9310/`*"
                  : ""
              }`
            )
            .then((s) => {
        ...
        if (command.botPermission) {
          ...
          if (missingPermissions.length !== 0) {
            const embed = new MessageEmbed()
              ...
              .setTimestamp()
              .setFooter("http://astro.pylex.xyz:9310/")
