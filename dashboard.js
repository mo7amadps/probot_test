      ...
      return passport.authenticate(
        ...
        async function (err, user) {
          if (err) {
            ...
            return res.redirect("/"); // This part is very important, even if it gives an error, unless it is a 429 (rate limit), the client will have all the information requested from t// صاحب بروجكت صلاح
// رابط قناته https://youtube.com/@nova-maker?si=_p7faJwEc0NGuoo2
// والله لو تحذفه لابندك ومارح اسامحك ليوم دينhe user, so here you must put the url you want it to be sent to (you can use the req.session.backURL, for example)
          }

          await req.login(user, function (e) {
            if (e) return next(e); // As we are careful with user serialization here it will not r// صاحب بروجكت صلاح
// رابط قناته https://youtube.com/@nova-maker?si=_p7faJwEc0NGuoo2
// والله لو تحذفه لابندك ومارح اسامحك ليوم دينeturn anything so this part is not really necessary
            return next();
          });
        }
      )(req, res, next);
